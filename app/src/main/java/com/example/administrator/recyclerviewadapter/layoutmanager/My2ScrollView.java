...
public class My2ScrollView extends ScrollView{
    private View childView;
    public My2ScrollView(Context context) {
        super(context);
    }
    public My2ScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public My2ScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if(absY > absX && absY >= UIUtils.dip2Px(10)){
